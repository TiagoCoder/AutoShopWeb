        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NIB = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Services_Orders", x => new { x.ServiceId, x.OrderId });
                    table.ForeignKey(
                        name: "FK_Services_Orders_Orders_OrderId",
                        column: x => x.OrderId,
                        principalTable: "Orders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Services_Orders_Services_ServiceId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Vehicle_Services", x => new { x.ServiceId, x.VehicleId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Services_Orders_OrderId",
